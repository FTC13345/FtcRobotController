...
public class RRMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(2.0, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(1.4, 0, 0);
...
//    private BNO055IMU imu;
    ...
    public RRMecanumDrive(HardwareMap hardwareMap, LinearOpMode opMode) {
        ...
        constraints = new MecanumConstraints(BASE_CONSTRAINTS, TRACK_WIDTH, WHEEL_BASE, LATERAL_MULTIPLIER);
        ...
        // 13345 Left side set to REVERSE if using AndyMark or goBilda 5202 yellow jacket motors
